...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Farooq\Desktop\10 Real_World_projects\Projects\App9(DjangoBlogAndTranslator)\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Farooq\Desktop\10 Real_World_projects\Projects\App9(DjangoBlogAndTranslator)\env\Scripts\deactivate.nu'
